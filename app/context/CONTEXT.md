# GitPilot Workspace Architecture Map
...
- **`llm/`** - AI layer (Zero dependencies on Git CLI).
  ...
  - `prompts.py` -> Core LLM prompt templates.

- **`ReleaseScheduler.py`** -> Utility for recommending optimal deployment windows (Replaces `commit_risk.py`).
